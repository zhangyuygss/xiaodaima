function [x, val, k] = newton_basic(f, g, hesse, x0, ifplot)
	...
	% ifplot: 1, plot figure  hesse: Hesse matrix of f	
	maxiter = 500;
	epsilon = 1e-5;
	...
	if(ifplot && length(x0)==2)		% Can only plot 2 dimension x variable figures
